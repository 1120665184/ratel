 ...
 * 知识文档格式判定工具。
 */
public final class KnowledgeFormatSupport {
    ...
    public static boolean isOffice(String fileName, String contentType) {
    ...
    public static boolean isDoc(String fileName, String contentType) {
        return matchesContentType(contentType, DOC_CONTENT_TYPES) || hasExtension(fileName, ".doc");
    }

    public static boolean isPptx(String fileName, String contentType) {
        return matchesContentType(contentType, PPTX_CONTENT_TYPES) || hasExtension(fileName, ".pptx");
    }

    public static boolean isXlsx(String fileName, String contentType) {
