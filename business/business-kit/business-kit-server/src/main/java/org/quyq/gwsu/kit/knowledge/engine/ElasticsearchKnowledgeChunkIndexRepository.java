...
public class ElasticsearchKnowledgeChunkIndexRepository implements KnowledgeChunkIndexRepository {
    ...
    public List<KnowledgeSearchResultVO> search(String keyword, Collection<String> visibleSourceDocumentIds, int size) {
        ...
        try {
            return elasticsearchOperations.search(searchQuery(keyword, visibleSourceDocumentIds, size),
                            KnowledgeChunkDocument.class,
                            indexCoordinates())
                    .stream()
    ...
    private Query searchQuery(String keyword, Collection<String> visibleSourceDocumentIds, int size) {
