package org.quyq.gwsu.security.headless.entrance.dingtalk.service.impl;
...
import org.quyq.gwsu.security.headless.entrance.dingtalk.utils.DingTalkCardUtils;
import org.quyq.gwsu.security.headless.entrance.dingtalk.utils.DingTalkMsgUtils;
import org.quyq.gwsu.security.headless.entrance.dingtalk.vo.UserStaffIdMappingInfo;
import org.quyq.gwsu.security.headless.enums.DingTalkMsgType;
...
public class DingTalkServiceImpl implements IDingTalkService {
    ...
    protected void agentCall(MsgSourceType sourceType, UserStaffIdMappingInfo mappingInfo, UserContent content) {
        ...
        headlessService.stream(content.content.getContent(), HeadlessCallConfig.builder()
                        .userId(mappingInfo.getSubjectId())
                        .build())
                .doOnNext(chunk -> {
