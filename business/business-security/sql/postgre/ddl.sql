...
COMMENT ON TABLE security_catalog IS 'Catalog定义表';
COMMENT ON COLUMN security_catalog.id IS '主键ID（雪花算法）';
COMMENT ON COLUMN security_catalog.catalog_key IS 'Catalog唯一标识';
COMMENT ON COLUMN security_catalog.catalog_name IS 'Catalog名称';
COMMENT ON COLUMN security_catalog.description IS 'Catalog描述';
COMMENT ON COLUMN security_catalog.version IS '版本号';
COMMENT ON COLUMN security_catalog.active IS '激活状态：0-未激活 1-激活（全局唯一）';
COMMENT ON COLUMN security_catalog.status IS '状态：0-禁用 1-正常';
COMMENT ON COLUMN security_catalog.tenant_id IS '租户ID';
COMMENT ON COLUMN security_catalog.create_op IS '创建人';
COMMENT ON COLUMN security_catalog.create_time IS '创建时间';
COMMENT ON COLUMN security_catalog.modify_op IS '修改人';
COMMENT ON COLUMN security_catalog.modify_time IS '修改时间';
COMMENT ON COLUMN security_catalog.deleted IS '删除标识：0-未删除 1-已删除';
COMMENT ON COLUMN security_catalog.delete_op IS '删除人';
COMMENT ON COLUMN security_catalog.delete_time IS '删除时间';

CREATE UNIQUE INDEX uk_catalog_key ON security_catalog (catalog_key) WHERE deleted = 0;
...
(
    ...
    default_props  TEXT                  DEFAULT NULL,
...
COMMENT ON TABLE security_catalog_component IS 'Catalog组件配置表';
COMMENT ON COLUMN security_catalog_component.id IS '主键ID（雪花算法）';
COMMENT ON COLUMN security_catalog_component.component_name IS '组件名（如 DataTable）';
COMMENT ON COLUMN security_catalog_component.description IS '组件描述（给AI看的）';
COMMENT ON COLUMN security_catalog_component.props_schema IS '组件属性JSON Schema定义';
COMMENT ON COLUMN security_catalog_component.default_props IS '默认属性值';
COMMENT ON COLUMN security_catalog_component.category IS '组件分类（display/chart/form）';
COMMENT ON COLUMN security_catalog_component.sort_order IS '排序号';
COMMENT ON COLUMN security_catalog_component.status IS '状态：0-禁用 1-正常';
COMMENT ON COLUMN security_catalog_component.tenant_id IS '租户ID';
COMMENT ON COLUMN security_catalog_component.create_op IS '创建人';
COMMENT ON COLUMN security_catalog_component.create_time IS '创建时间';
COMMENT ON COLUMN security_catalog_component.modify_op IS '修改人';
COMMENT ON COLUMN security_catalog_component.modify_time IS '修改时间';
COMMENT ON COLUMN security_catalog_component.deleted IS '删除标识：0-未删除 1-已删除';
COMMENT ON COLUMN security_catalog_component.delete_op IS '删除人';
COMMENT ON COLUMN security_catalog_component.delete_time IS '删除时间';

CREATE UNIQUE INDEX uk_component_name ON security_catalog_component (component_name) WHERE deleted = 0;
...
(
    id           VARCHAR(24) PRIMARY KEY,
    catalog_id   VARCHAR(24) NOT NULL,
...
COMMENT ON TABLE security_catalog_component_ref IS 'Catalog与组件关联表';
COMMENT ON COLUMN security_catalog_component_ref.id IS '主键ID（雪花算法）';
COMMENT ON COLUMN security_catalog_component_ref.catalog_id IS 'Catalog ID';
COMMENT ON COLUMN security_catalog_component_ref.component_id IS '组件ID';
COMMENT ON COLUMN security_catalog_component_ref.sort_order IS '排序号';
COMMENT ON COLUMN security_catalog_component_ref.tenant_id IS '租户ID';
COMMENT ON COLUMN security_catalog_component_ref.create_op IS '创建人';
COMMENT ON COLUMN security_catalog_component_ref.create_time IS '创建时间';
COMMENT ON COLUMN security_catalog_component_ref.modify_op IS '修改人';
COMMENT ON COLUMN security_catalog_component_ref.modify_time IS '修改时间';
COMMENT ON COLUMN security_catalog_component_ref.deleted IS '删除标识：0-未删除 1-已删除';
COMMENT ON COLUMN security_catalog_component_ref.delete_op IS '删除人';
COMMENT ON COLUMN security_catalog_component_ref.delete_time IS '删除时间';

CREATE UNIQUE INDEX uk_catalog_component ON security_catalog_component_ref (catalog_id, component_id) WHERE deleted = 0;
CREATE INDEX idx_catalog_id ON security_catalog_component_ref (catalog_id) WHERE deleted = 0;
