...
INSERT INTO security_abac_permission (id, tenant_id, abac_id, resource_type, action, url_pattern, effect, status, create_op, create_time, modify_op, modify_time, delete_op, delete_time, deleted) VALUES ('2059280380317581313', 'default', '2059099745615486976', 'security', 'GET', '/role/rolesByCurrUser', 'allow', 1, 'admin', '2026-05-26 22:27:56.943043', 'admin', '2026-05-26 22:27:56.943043', NULL, NULL, 0);
INSERT INTO security_abac_permission (id, tenant_id, abac_id, resource_type, action, url_pattern, effect, status, create_op, create_time, modify_op, modify_time, delete_op, delete_time, deleted) VALUES ('2059280380397273089', 'default', '2059099745615486976', 'system', 'PUT', '/manager/password', 'allow', 1, 'admin', '2026-05-26 22:27:56.945633', 'admin', '2026-05-26 22:27:56.945633', NULL, NULL, 0);
...
INSERT INTO security_config (id, config_key, config_name, config_value, value_type, config_type, description, tenant_id, create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time) VALUES ('2060910412299448320', 'assistant_llm_config', '助手配置', '{"provider":"openai","dashscope":{"apiKey":"","modelName":"qwen-plus","stream":true,"enableThinking":false,"enableSearch":false,"baseUrl":""},"openai":{"apiKey":"","modelName":"deepseek-v4-flash","stream":true,"baseUrl":"https://api.deepseek.com","endpointPath":"/chat/completions"},"gemini":{"apiKey":"","modelName":"gemini-2.0-flash","stream":true,"project":"","location":"us-central1"},"anthropic":{"apiKey":"","modelName":"claude-sonnet-4-5-20250929","stream":true,"baseUrl":""},"generateOptions":{"temperature":0.2,"topP":0.75,"frequencyPenalty":0.5,"presencePenalty":0.5,"additionalBodyParams":{"thinking":{"type":"enabled"},"reasoning":{"effort":"medium"}}}}', 4, 1, 'AI 助手模型提供商及生成参数配置', NULL, 'admin', '2026-05-31 10:25:06.816008', 'admin', '2026-06-02 23:11:03.469723', 0, NULL, NULL);
...
INSERT INTO security_menu (id, parent_id, menu_name, menu_type, sort, icon, path, visible, status, permission, tenant_id, create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time, position, owner, button_key, description) VALUES ('72970706', '4', '编辑用户', 3, 0, NULL, NULL, 1, 1, 'POST:system:/manager/{id}/account;DELETE:system:/manager/{id}/account/{accountId};DELETE:system:/user-dept;POST:system:/user-dept;PUT:system:/user-dept/primary;(main)POST:system:/manager', NULL, 'admin', '2026-04-30 10:52:37.283618', 'admin', '2026-04-30 14:57:40.581134', 0, NULL, NULL, 1, 1, '4_edit', '编辑已有用户信息，包含基本信息、账号绑定/解绑、部门关联');
