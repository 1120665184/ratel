...
INSERT INTO security_config (id, config_key, config_name, config_value, value_type, config_type, description, tenant_id, create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time) VALUES ('2060910412291281761', 'captcha_config', '验证码配置', '{"aesStatus":true,"cacheNumber":"1000","clickWordCount":4,"enabled":true,"expireSeconds":300,"fontSize":25,"fontStyle":1,"fontType":"WenQuanZhengHei.ttf","historyDataClearEnable":false,"interferenceOptions":"0","jigsaw":"","picClick":"","reqCheckMinuteLimit":100,"reqFrequencyLimitEnable":false,"reqGetLockLimit":5,"reqGetLockSeconds":300,"reqGetMinuteLimit":100,"reqVerifyMinuteLimit":100,"slipOffset":"5","timingClear":"180","type":"BLOCK_PUZZLE","waterFont":"WenQuanZhengHei.ttf","waterMark":"Ratel-Manager"}', 4, 1, '登录验证码默认配置', NULL, 'admin', '2026-09-01 00:00:00', 'admin', '2026-09-01 00:00:00', 0, NULL, NULL);
