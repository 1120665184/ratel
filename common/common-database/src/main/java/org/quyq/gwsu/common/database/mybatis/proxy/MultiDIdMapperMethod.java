...
import org.quyq.gwsu.common.database.mybatis.proxy.command.MultiDIdSqlCommand;
 ...
 * @description
 */
public class MultiDIdMapperMethod {

    private final MultiDIdSqlCommand command;
    private final MapperMethod.MethodSignature method;

    public MultiDIdMapperMethod(Class<?> mapperInterface, Method method, Configuration config, String databaseId) {
        this.command = new MultiDIdSqlCommand(config, mapperInterface, method, databaseId);
    ...
    private void executeWithResultHandler(SqlSession sqlSession, Object[] args) {
        ...
        if (!StatementType.CALLABLE.equals(ms.getStatementType())
                && void.class.equals(ms.getResultMaps().getFirst().getType())) {
            throw new BindingException(
