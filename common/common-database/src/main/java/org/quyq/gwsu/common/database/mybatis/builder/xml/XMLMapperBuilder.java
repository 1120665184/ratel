package org.quyq.gwsu.common.database.mybatis.builder.xml;
...
import org.quyq.gwsu.common.database.mybatis.builder.MultiDatabaseIdMapperBuilderAssistant;
...
public class XMLMapperBuilder extends BaseBuilder {
    ...
    private XMLMapperBuilder(XPathParser parser, Configuration configuration, String resource,
                             Map<String, XNode> sqlFragments) {
        super(configuration);
        this.builderAssistant = new MultiDatabaseIdMapperBuilderAssistant(configuration, resource);
        this.parser = parser;
    ...
    private void buildStatementFromContext(List<XNode> list, String requiredDatabaseId) {
        for (XNode context : list) {
            final XMLStatementBuilder statementParser = new MultiDIdXMLStatementBuilder(configuration, builderAssistant, context,
                    requiredDatabaseId);
            try {
