...
public class AjCaptchaProperties {
    ...
    public Properties toCaptchaServiceProperties(CaptchaProperties commonProperties, CaptchaType requestType) {
        CaptchaType captchaType = commonProperties.effectiveType(requestType);
        Properties properties = new Properties();
        properties.put("captcha.cacheType", "redis");
        properties.put("captcha.type", captchaType.getCode());
        properties.put("captcha.water.mark", commonProperties.effectiveWaterMark());
