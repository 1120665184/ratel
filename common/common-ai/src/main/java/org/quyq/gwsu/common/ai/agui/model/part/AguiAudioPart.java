...
public record AguiAudioPart(String type, AguiContentSource source, Map<String, Object> metadata)
        implements AguiContentPart {

    @JsonCreator
    public AguiAudioPart(@JsonProperty("type") String type,
                         @JsonProperty("source") AguiContentSource source,
                         @JsonProperty("metadata") Map<String, Object> metadata) {
        this.type = type == null || type.isBlank() ? "audio" : type;
        this.source = source;
